  ...
  it.each([
    {
      ...
      cfg: { channels: { zalo: {} } },
      expected:
        "Zalo token not configured for account default (set channels.zalo.botToken, channels.zalo.tokenFile, channels.zalo.accounts.default.botToken, channels.zalo.accounts.default.tokenFile, or ZALO_BOT_TOKEN)",
    },
    {
    ...
    },
    {
      ...
      expected:
        "Zalo token not configured for account work (set channels.zalo.accounts.work.botToken, channels.zalo.accounts.work.tokenFile, channels.zalo.botToken, or channels.zalo.tokenFile)",
    },
